package net.chr.screenrecorder.service;
...
import net.chr.screenrecorder.ui.activity.ScreenRecordActivity;
import net.chr.screenrecorder.R;
import net.chr.screenrecorder.model.DanmakuBean;
import net.chr.screenrecorder.view.MyWindowManager;
