package net.chr.screenrecorder.core;
...
import net.chr.screenrecorder.task.AudioSenderThread;
...
public class RESSoftAudioCore {
    ...
    public boolean prepare() {
        synchronized (syncOp) {
            ...
            resCoreParameters.mediacodecAACChannelCount = 2;
            resCoreParameters.mediacodecAACBitRate = 32 * 1024*10;
...
//                         dstAudioEncoder = MediaCodec.createEncoderByType("audio/mp4a-latm");
//                         dstAudioEncoder.configure(encodeFormat, null, null, MediaCodec.CONFIGURE_FLAG_ENCODE);
//                     } catch (Exception e) {
//                         e.printStackTrace();
//                   }
            ///////////////
