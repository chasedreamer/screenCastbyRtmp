...
public abstract class MediaVideoEncoderBase extends MediaEncoder {
	...
	public MediaVideoEncoderBase(final MediaMuxerWrapper muxer, RESFlvDataCollecter collecter, final MediaEncoderListener listener, final int width, final int height) {
		super(muxer, collecter,listener);
		mWidth = width;
		mHeight = height;
	}
