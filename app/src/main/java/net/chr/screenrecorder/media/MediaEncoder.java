package net.chr.screenrecorder.media;
/*
...
//lxk
	RESFlvDataCollecter mDataCollecter;
    ...
    public MediaEncoder(final MediaMuxerWrapper muxer, RESFlvDataCollecter collecter, final MediaEncoderListener listener) {
...
//						Log.e(TAG, "recordVirtualDisplay: ==="+encodedData.remaining());
//						byte[] finalBuff = new byte[10];
//						encodedData.get(finalBuff, mBufferInfo.offset, 10);
//
...
//						Log.e(TAG, "referenceBit: "+ referenceBit );
						...
						sendRealData(getPTSUs()/1000, encodedData);
					}
					else
					{
