...
import net.chr.screenrecorder.rtmp.FLvMetaData;
import net.chr.screenrecorder.rtmp.RESFlvData;
import net.chr.screenrecorder.rtmp.RtmpClient;
                ...
                switch (state) {
                    ...
                    case STATE.RUNNING:
                        ...
                        if (writeMsgNum >= (maxQueueLength * 2 / 3) && flvData.flvTagType == RESFlvData.FLV_RTMP_PACKET_TYPE_VIDEO && flvData.droppable) {
                            ...
                            Log.e("RtmpStreamingSender","senderQueue is crowded,abandon video");
                            break;
                        }
