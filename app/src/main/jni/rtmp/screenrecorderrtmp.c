...
JNIEXPORT jlong JNICALL Java_net_chr_screenrecorder_rtmp_RtmpClient_open
...
/*
 * Class:     net_chr_screenrecorder_rtmp_RtmpClient
 * Method:    read
 * Signature: (J[BII)I
 */
JNIEXPORT jint JNICALL Java_net_chr_screenrecorder_rtmp_RtmpClient_read
 ...
 * Signature: (J[BIII)I
 */
JNIEXPORT jint JNICALL Java_net_chr_screenrecorder_rtmp_RtmpClient_write
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_net_chr_screenrecorder_rtmp_RtmpClient_close
 ...
 */
JNIEXPORT jstring JNICALL Java_net_chr_screenrecorder_rtmp_RtmpClient_getIpAddr
